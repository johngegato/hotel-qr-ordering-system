        ...
        .insert([
          {
            ...
            status: 'PENDING',
            payload: { room_number: roomNumber, note: 'Guest requested a callback' },
          },
        ])
        .select('id')
        .single()
      ...
      <div className="glass-strong rounded-3xl p-6 max-w-sm w-full relative overflow-hidden animate-fade-up">
        ...
        {status === 'IDLE' && (
          <div className="space-y-3">
            ...
            >
              <span>📱</span> Call Now ({hotelPhone || 'Front Desk'})
            </a>
            ...
            >
              <span>🛎️</span> Request Front Desk to Call Me
            </button>
          </div>
        )}
        ...
        {/* State 3: CLAIMED (Loop Closure Success) */}
        {status === 'CLAIMED' && (
